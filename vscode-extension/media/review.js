...
`;
  ...
  function createMarkdownRenderer() {
    const renderer = new MarkdownItCallable({ html: false, linkify: true }).use(taskLists, { enabled: false, label: true });
  ...
  (() => {
    ...
    function persist() {
      vscode.setState({ level, view, splitPosition, splitStateVersion });
    }
    ...
    function setMarkerNamespace() {
      ...
      } while (text2.includes(markerNamespace));
    }
